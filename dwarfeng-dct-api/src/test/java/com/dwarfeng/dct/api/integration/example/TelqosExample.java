package com.dwarfeng.dct.api.integration.example;
...
public class TelqosExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("这是一个示例, 用于演示 dwarfeng-dct 的 Telqos 功能");
        System.out.println("您可以使用 telnet 客户端工具访问本机 ${telqos.port} 端口以体验本示例的功能");
        System.out.println("您可以使用 telqos 的 dcoding 与 vcoding 命令以体验 DCT 编解码 QoS 服务");
