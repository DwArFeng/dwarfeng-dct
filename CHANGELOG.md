...
## Release_1.1.2_20260310_build_A
...
## Release_1.1.1_20260102_build_A

### 功能构建

- Wiki 编写。
  - docs/wiki/zh-CN/ExtendValueCodec.md。
...
- 类优化注释、文档注释格式、代码换行格式。
  - com.dwarfeng.dct.util.ServiceExceptionHelper。
...
- 依赖升级。
  ...
  - 升级 `subgrade` 依赖版本为 `1.7.2.a` 以规避漏洞。
